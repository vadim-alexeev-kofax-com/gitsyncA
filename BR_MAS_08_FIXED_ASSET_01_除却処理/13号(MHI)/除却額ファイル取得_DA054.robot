                                                ...
                                                "applicationFinder": {
                                                  ...
                                                  "gizmo":{
                                                    ...
                                                    "applicationSelector": {
                                                      ...
                                                      "gizmo":{
                                                        "text": { "string": "saplogon.exe[className=\"#32770\"][title=\"固定資産一括除却・移管出\"]" }
                                                      }
                                                    }
                                                  }
                                                },
                                            ...
                                            "finder": {
                                              ...
                                              "gizmo":{
                                                "applicationFinder": {
                                                  ...
                                                  "gizmo":{
                                                    ...
                                                    "applicationSelector": {
                                                      ...
                                                      "gizmo":{
                                                        "text": { "string": "saplogon.exe[hasFocus=\"true\"][title*=\"固定資産一括除却・移管出\"]" }
                                                      }
                                                    }
                                                  }
                                                },
                                                "componentSelector": {
                                                  ...
                                                  "gizmo":{
                                                    "text": { "string": "DY_PATH[sapId=\"/app/con[0]/ses[0]/wnd[1]/usr/ctxtDY_PATH\"]" }
                                                  }
                                                }
                                              }
                                            }
