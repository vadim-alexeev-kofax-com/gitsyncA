                            ...
                            "branches": [{
                              ...
                              "gizmo":{
                                "condition": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=contains(taskName,\"SAP Easy Access\")" }
                                  }
                                },
                                "block": {
                                  "meta":{
                                                    ...
                                                    "finder": {
                                                      ...
                                                      "gizmo":{
                                                        ...
                                                        "componentSelector": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "一覧項目[name*=\"SAP Easy Access\"]" }
                                                          }
                                                        }
                                                      }
                                                    }
