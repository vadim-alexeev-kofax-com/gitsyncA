                                            ...
                                            "applicationFinder": {
                                              ...
                                              "gizmo":{
                                                ...
                                                "applicationSelector": {
                                                  ...
                                                  "gizmo":{
                                                    "text": { "string": "saplogon.exe[title=\"ABAP: プログラム ZMLFI031 のバリアントディレクトリ\"]" }
                                                  }
                                                }
                                              }
                                            },
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "完工年月日ToGroup" }
                      }
                    },
                    "comment": {
                      "meta":{
                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "仕事終了日FromClick Step" }
                              }
                            },
                            "comment": {
                              "meta":{
                        ...
                        },
                        {
                          ...
                          "gizmo":{
                            ...
                            "contents": {
                              ...
                              "gizmo":{
                                "text": { "string": "=local.inputItemsKanzyotsukiMatsuzitu" }
                              }
                            }
                          }
                        },
