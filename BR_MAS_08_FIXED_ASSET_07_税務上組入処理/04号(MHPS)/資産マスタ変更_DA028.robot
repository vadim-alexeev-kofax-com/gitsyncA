                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            ...
                            "contents": {
                              ...
                              "gizmo":{
                                "text": { "string": "=lcl.workFolderPath + CNST.KEY_UPDATE_FILE_NAME" }
                              }
                            }
                          }
                        },
                                            ...
                                            "applicationFinder": {
                                              ...
                                              "gizmo":{
                                                ...
                                                "applicationSelector": {
                                                  ...
                                                  "gizmo":{
                                                    "text": { "string": "=\"saplogon.exe[title=\\\"\"+lcl.sapShisanHenkoScName+\"\\\"]\"" }
                                                  }
                                                }
                                              }
                                            },
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "テスト実行クリック(チェックを解除)" }
                      }
                    },
                    "comment": {
                      "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "P_TEST[checked=\"true\"]" }
                                      }
                                    }
                                  }
                                }
                                ...
                                },
                                {
                                  ...
                                  "gizmo":{
                                    "name": {
                                      ...
                                      "gizmo":{
                                        "customName": { "string": "エラー対策(Try-Catch)" }
                                      }
                                    },
                                    "comment": {
                                      "meta":{
                                                    ...
                                                    "steps": [{
                                                      ...
                                                      "gizmo":{
                                                        "name": {
                                                          ...
                                                          "gizmo":{
                                                            "customName": { "string": "実行後件数取得(Try-Catch)" }
                                                          }
                                                        },
                                                        "comment": {
                                                          "meta":{
                                                                                    ...
                                                                                    },
                                                                                    {
                                                                                      ...
                                                                                      "gizmo":{
                                                                                        "name": {
                                                                                          ...
                                                                                          "gizmo":{
                                                                                            "customName": { "string": "取得失敗対策(Try-Catch)" }
                                                                                          }
                                                                                        },
                                                                                        "comment": {
                                                                                          "meta":{
                                                    ...
                                                    "steps": [{
                                                      ...
                                                      "gizmo":{
                                                        "name": {
                                                          ...
                                                          "gizmo":{
                                                            "customName": { "string": "内容不備エラーによるファイル保存" }
                                                          }
                                                        },
                                                        "comment": {
                                                          "meta":{
                                                            ...
                                                            },
                                                            {
                                                              ...
                                                              "gizmo":{
                                                                "name": {
                                                                  ...
                                                                  "gizmo":{
                                                                    "customName": { "string": "エラーファイル保存名CBセット" }
                                                                  }
                                                                },
                                                                "comment": {
                                                                  "meta":{
                                                                ...
                                                                "contents": {
                                                                  ...
                                                                  "gizmo":{
                                                                    "text": { "string": "=lcl.compressedFolderPath+lcl.outputShisanMstUpdateErrorFileName" }
                                                                  }
                                                                }
                                                              }
                                                            },
