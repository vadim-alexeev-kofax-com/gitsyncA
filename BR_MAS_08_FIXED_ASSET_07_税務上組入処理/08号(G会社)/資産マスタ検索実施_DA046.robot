                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "【正常終了】資産マスタデータ選択無の場合" }
                      }
                    },
                    "comment": {
                      "meta":{
                        ...
                        },
                        {
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "ローカルファイル保存選択ループ" }
                              }
                            },
                            "comment": {
                              "meta":{
                                ...
                                "steps": [{
                                  ...
                                  "gizmo":{
                                    "name": {
                                      ...
                                      "gizmo":{
                                        "customName": { "string": "DeviceIssue対策(Try-Catch)" }
                                      }
                                    },
                                    "comment": {
                                      "meta":{
                                        ...
                                        },
                                        {
                                          ...
                                          "gizmo":{
                                            "name": {
                                              ...
                                              "gizmo":{
                                                "customName": { "string": "一覧をファイルに保存を確認" }
                                              }
                                            },
                                            "comment": {
                                              "meta":{
                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "スプレッドシートをクリック" }
                              }
                            },
                            "comment": {
                              "meta":{
                                ...
                                },
                                {
                                  ...
                                  "gizmo":{
                                    ...
                                    "contents": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=CNST.ASSET_DATE_UPDATE_FILE_NAME" }
                                      }
                                    }
                                  }
                                },
