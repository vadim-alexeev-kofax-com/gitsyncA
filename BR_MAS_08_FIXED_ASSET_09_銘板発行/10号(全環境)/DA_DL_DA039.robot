...
<object class="Robot2" serializationversion="2">
  ...
  "gizmo":{
    "parameters": [{
      ...
      "gizmo":{
        "id": { "string": "lcl_MeibanRowDataFolderPath" },
        "typ": {
          "meta":{
            "className":"TypeUse",
            "version":0
    ...
    },
    {
      ...
      "gizmo":{
        "id": { "string": "lcl_MeibanRowDataFileName" },
        "typ": {
          "meta":{
            "className":"TypeUse",
            "version":0
        ...
        "finder": {
          ...
          "gizmo":{
            ...
            "applicationSelector": {
              ...
              "gizmo":{
                "text": { "string": "saplogon.exe[title=\"固定資産銘板印刷データ（要求課別）\"]" }
              }
            }
          }
        },
                ...
                "steps": [{
                  ...
                  "gizmo":{
                    ...
                    "contents": {
                      ...
                      "gizmo":{
                        "text": { "string": "=lcl_MeibanRowDataFolderPath" }
                      }
                    }
                  }
                },
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "SPOPLI-SELFLAG[sapId=\"/app/con[0]/ses[0]/wnd[1]/usr/subSUBSCREEN_STEPLOOP:SAPLSPO5:0150/sub:SAPLSPO5:0150/radSPOPLI-SELFLAG[1,0]\"]" }
                                      }
                                    }
                                  }
                                }
                                    ...
                                    "applicationFinder": {
                                      ...
                                      "gizmo":{
                                        ...
                                        "applicationSelector": {
                                          ...
                                          "gizmo":{
                                            "text": { "string": "saplogon.exe[className=\"#32770\"][title=\"固定資産銘板印刷データ（要求課別）\"]" }
                                          }
                                        }
                                      }
                                    },
                ...
                },
                {
                  ...
                  "gizmo":{
                    ...
                    "contents": {
                      ...
                      "gizmo":{
                        "text": { "string": "=lcl_MeibanRowDataFileName" }
                      }
                    }
                  }
                },
