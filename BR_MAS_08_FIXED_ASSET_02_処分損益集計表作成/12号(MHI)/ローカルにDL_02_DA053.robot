        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "一覧をファイルに保存する" }
              }
            },
            "comment": {
              "meta":{
                            ...
                            "applicationFinder": {
                              ...
                              "gizmo":{
                                ...
                                "applicationSelector": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "saplogon.exe[className=\"#32770\"][title=\"勘定コード明細照会\"]" }
                                  }
                                }
                              }
                            },
