                            ...
                            "applicationFinder": {
                              ...
                              "gizmo":{
                                ...
                                "applicationSelector": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "saplogon.exe[className=\"#32770\"][title=\"EC-PCA: 管理領域 MHI に対する利益センタのマスタ\"]" }
                                  }
                                }
                              }
                            },
