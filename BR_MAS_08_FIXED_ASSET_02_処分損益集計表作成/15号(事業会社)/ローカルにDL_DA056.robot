...
<object class="Robot2" serializationversion="2">
  ...
  "gizmo":{
    ...
    },
    {
      ...
      "gizmo":{
        "id": { "string": "CONST_SYOBUNSONEKIHAAKU_REPORT_FILE_NAME" },
        "typ": {
          "meta":{
            "className":"TypeUse",
            "version":0
        ...
        },
        {
          ...
          "gizmo":{
            ...
            "contents": {
              ...
              "gizmo":{
                "text": { "string": "=CONST_SYOBUNSONEKIHAAKU_REPORT_FILE_NAME+\".xls\"" }
              }
            }
          }
        },
                            ...
                            "applicationFinder": {
                              ...
                              "gizmo":{
                                ...
                                "applicationSelector": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "saplogon.exe[className=\"#32770\"][title=\"固定資産処分損益把握レポート\"]" }
                                  }
                                }
                              }
                            },
