        ...
        "steps": [{
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Try-Catch-選択画面" }
              }
            },
            "comment": {
              "meta":{
                                    ...
                                    "applicationFinder": {
                                      ...
                                      "gizmo":{
                                        ...
                                        "applicationSelector": {
                                          ...
                                          "gizmo":{
                                            "text": { "string": "saplogon.exe[title*=\"指図書マスタ項目変更\"]" }
                                          }
                                        }
                                      }
                                    },
                                    ...
                                    "applicationFinder": {
                                      ...
                                      "gizmo":{
                                        ...
                                        "applicationSelector": {
                                          ...
                                          "gizmo":{
                                            "text": { "string": "saplogon.exe[title=\"指図書マスタ項目変更ＰＣ版[KO02]\"]" }
                                          }
                                        }
                                      }
                                    },
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Click Step-エラー画面か確認" }
              }
            },
            "comment": {
              "meta":{
