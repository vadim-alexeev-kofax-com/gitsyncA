...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <tags/>
    <referenced-types>
      <type name="InputParametersShort"/>
    </referenced-types>
    <referenced-snippets/>
    <triggers/>
    <typed-variables>
      <typed-variable name="inputvar" type-name="InputParametersShort"/>
    </typed-variables>
    <global-variables/>
    <parameters>
      <parameter name="inputvar" type-name="InputParametersShort"/>
    </parameters>
    <return-variables>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String">inputvar</property>
      <property name="parameter" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">InputParametersShort</property>
        </property>
        <property name="assignments" class="AttributeAssignments">
          <property name="shorttextinput" class="AttributeAssignment">
            <property name="attributeValue" class="String">qwerty</property>
      ...
      <object class="Transition" serializationversion="3" id="3">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">http://www.goole.com</property>
          </property>
