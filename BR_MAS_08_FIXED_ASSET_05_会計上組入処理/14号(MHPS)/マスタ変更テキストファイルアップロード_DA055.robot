                            ...
                            "applicationFinder": {
                              ...
                              "gizmo":{
                                ...
                                "applicationSelector": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "saplogon.exe[title*=\"資産マスタ変更\"]" }
                                  }
                                }
                              }
                            },
                ...
                "steps": [{
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "テスト実行クリックClick Step" }
                      }
                    },
                    "comment": {
                      "meta":{
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "取り込みファイルGroup" }
                      }
                    },
                    "comment": {
                      "meta":{
                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "取り込みファイルClick Step" }
                              }
                            },
                            "comment": {
                              "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "処理結果待ち10sGuarded Choice" }
              }
            },
            "comment": {
              "meta":{
                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "エラーファイルGroup" }
                              }
                            },
                            "comment": {
                              "meta":{
                                ...
                                "steps": [{
                                  ...
                                  "gizmo":{
                                    "name": {
                                      ...
                                      "gizmo":{
                                        "customName": { "string": "情報タブClick Step" }
                                      }
                                    },
                                    "comment": {
                                      "meta":{
                        ...
                        },
                        {
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "エラー件数取得Extract Contents" }
                              }
                            },
                            "comment": {
                              "meta":{
                        ...
                        },
                        {
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "取込件数取得Extract Contents" }
                              }
                            },
                            "comment": {
                              "meta":{
                        ...
                        },
                        {
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "登録件数取得Extract Contents" }
                              }
                            },
                            "comment": {
                              "meta":{
                                            ...
                                            "steps": [{
                                              ...
                                              "gizmo":{
                                                ...
                                                "leftHandSide": {
                                                  ...
                                                  "gizmo":{
                                                    "text": { "string": "REGISTRATION_COUNT" }
                                                  }
                                                }
                                              }
                                            }]
                                    ...
                                    "steps": [{
                                      ...
                                      "gizmo":{
                                        "name": {
                                          ...
                                          "gizmo":{
                                            "customName": { "string": "アップロードできないエラーMsg取得" }
                                          }
                                        },
                                        "comment": {
                                          "meta":{
