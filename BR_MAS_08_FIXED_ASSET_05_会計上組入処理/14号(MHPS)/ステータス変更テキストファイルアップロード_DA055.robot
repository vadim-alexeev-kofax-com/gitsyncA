                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            "applicationFinder": {
                              ...
                              "gizmo":{
                                ...
                                "applicationSelector": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "saplogon.exe[title*=\"締ＯＰＡ技術的完了ＰＣ版\"]" }
                                  }
                                }
                              }
                            },
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "ウィンドウ[name*=\"締ＯＰＡ技術的完了ＰＣ版\"]" }
                              }
                            }
                          }
                        }
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "指図書マスタ決済規則更新" }
              }
            },
            "comment": {
              "meta":{
                ...
                "steps": [{
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "変更済みのものをエラーとしないクリックClick Step" }
                      }
                    },
                    "comment": {
                      "meta":{
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                "name": {
                                  ...
                                  "gizmo":{
                                    "customName": { "string": "処理結果待ち20sGuarded Choice" }
                                  }
                                },
                                "comment": {
                                  "meta":{
