                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "ANLB-XAFBE[index=\"0\"]" }
                              }
                            }
                          }
                        }
                                    ...
                                    "steps": [{
                                      ...
                                      "gizmo":{
                                        "name": {
                                          ...
                                          "gizmo":{
                                            "customName": { "string": "Extract Contents" }
                                          }
                                        },
                                        "comment": {
                                          "meta":{
                                                    ...
                                                    "finder": {
                                                      ...
                                                      "gizmo":{
                                                        ...
                                                        "componentSelector": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "=\"ANLB-AFABE[sapId=\\\"/app/con[0]/ses[0]/wnd[0]/usr/subTABSTRIP:SAPLATAB:0100/tabsTABSTRIP100/tabpTAB08/ssubSUBSC:SAPLATAB:0201/subAREA1:SAPLAIST:1190/tblSAPLAISTTC_ANLB/ctxtANLB-AFABE[1,\"+finderNum+\"]\\\"]\"" }
                                                          }
                                                        }
                                                      }
                                                    }
            ...
            },
            {
              ...
              "gizmo":{
                "condition": {
                  ...
                  "gizmo":{
                    "text": { "string": "=kaikeijoShisanFlg==true" }
                  }
                },
                "block": {
                  "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"ANLB-XAFBE[sapId=\\\"/app/con[0]/ses[0]/wnd[0]/usr/subTABSTRIP:SAPLATAB:0100/tabsTABSTRIP100/tabpTAB08/ssubSUBSC:SAPLATAB:0201/subAREA1:SAPLAIST:1190/tblSAPLAISTTC_ANLB/chkANLB-XAFBE[0,\"+finderNum+\"]\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                    ...
                    "branches": [{
                      ...
                      "gizmo":{
                        "condition": {
                          ...
                          "gizmo":{
                            "text": { "string": "=forEnterCheck==\"true\"" }
                          }
                        },
                        "block": {
                          "meta":{
