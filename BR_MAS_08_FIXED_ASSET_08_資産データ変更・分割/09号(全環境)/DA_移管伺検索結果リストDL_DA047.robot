...
<object class="Robot2" serializationversion="2">
  ...
  "gizmo":{
    "parameters": [{
      ...
      "gizmo":{
        "id": { "string": "searchResultListFullPath" },
        "typ": {
          "meta":{
            "className":"TypeUse",
            "version":0
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "検索結果一覧出力クリック" }
              }
            },
            "comment": {
              "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "名前を付けて保存をクリック" }
              }
            },
            "comment": {
              "meta":{
                            ...
                            "steps": [{
                              ...
                              "gizmo":{
                                ...
                                "contents": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=searchResultListFullPath" }
                                  }
                                }
                              }
                            },
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "ボタン[name=\"ダウンロードの表示\"]" }
                                      }
                                    }
                                  }
                                }
                ...
                "steps": [{
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "上書ポップアップが表示された場合" }
                      }
                    },
                    "comment": {
                      "meta":{
