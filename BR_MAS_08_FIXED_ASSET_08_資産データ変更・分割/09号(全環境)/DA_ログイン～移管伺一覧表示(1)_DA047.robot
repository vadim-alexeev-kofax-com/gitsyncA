                ...
                "steps": [{
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "ユーザIDカーソル合わせる" }
                      }
                    },
                    "comment": {
                      "meta":{
                                        ...
                                        "finder": {
                                          ...
                                          "gizmo":{
                                            ...
                                            "componentSelector": {
                                              ...
                                              "gizmo":{
                                                "text": { "string": "A[href=\"javascript:forwardPage('_toTransferList_')\"]" }
                                              }
                                            }
                                          }
                                        }
