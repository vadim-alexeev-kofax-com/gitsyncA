        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "CSVダウンロードをクリック" }
              }
            },
            "comment": {
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "INPUT[value=\"CSVダウンロード\"]" }
                              }
                            }
                          }
                        }
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "名前を付けて保存クリック" }
              }
            },
            "comment": {
              "meta":{
                            ...
                            "branches": [{
                              ...
                              "gizmo":{
                                "condition": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=saveText==fileName+\" のダウンロードが完了しました。\"" }
                                  }
                                },
                                "block": {
                                  "meta":{
                                                    ...
                                                    "finder": {
                                                      ...
                                                      "gizmo":{
                                                        ...
                                                        "componentSelector": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "ボタン[depth=\"6\"][name=\"閉じる\"]" }
                                                          }
                                                        }
                                                      }
                                                    }
                                                    ...
                                                    "finder": {
                                                      ...
                                                      "gizmo":{
                                                        ...
                                                        "componentSelector": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "INPUT[onclick=\" if (true) { return confirm('保存していない場合、内容が破棄されますが宜しいですか？'); } \"]" }
                                                          }
                                                        }
                                                      }
                                                    }
