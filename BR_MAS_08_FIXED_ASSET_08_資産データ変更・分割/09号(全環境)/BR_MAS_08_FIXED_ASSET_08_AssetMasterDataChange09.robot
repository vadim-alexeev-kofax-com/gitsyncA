...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <triggers/>
    <sub-robots>
      <sub-robot name="DA_画面初期化(3)_DA047"/>
      <sub-robot name="資産データ変更・分割_DA_Web固定資産システム起動(1)_DA047"/>
      <sub-robot name="DA_ログイン～移管伺一覧表示(1)_DA047"/>
      <sub-robot name="DA_検索条件入力・検索実行(1)_DA047"/>
      <sub-robot name="DA_移管伺検索結果リストDL_DA047"/>
      <sub-robot name="DA_画面初期化(3)_02_DA047"/>
      <sub-robot name="資産データ変更・分割_DA_Web固定資産システム起動(1)_DA047"/>
      <sub-robot name="DA_ログイン～移管伺一覧表示(1)_DA047"/>
      <sub-robot name="DA_検索条件入力・検索実行(2)_DA047"/>
      <sub-robot name="DA_申請番号で検索_DA047"/>
      <sub-robot name="DA_完了年月日取得_DA047"/>
      <sub-robot name="DA_編集ボタンクリック_DA047"/>
      <sub-robot name="DA_CSVファイルDL～移管伺一覧へ戻る_DA047"/>
      <sub-robot name="DA_マスタ変更データDL_DA047"/>
      <sub-robot name="DA_画面初期化(3)_02_DA047"/>
      <sub-robot name="DA_画面初期化(3)_DA047"/>
      <sub-robot name="DA_画面初期化(3)_DA047"/>
      <sub-robot name="DA_画面初期化(3)_DA047"/>
    ...
    <referenced-snippets>
      ...
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPBunkatsuShori_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_VbsFileCopy"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPHenkoErrShori_DA047"/>
      ...
      <snippet name="ExeceuteMacroOnDA_BR_MAS_08_FIXED_ASSET_DA047"/>
      ...
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPListDLForCheck_DA047"/>
      ...
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPKanzenReport_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPBubunReport_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_GetSAPInformation"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPListDL_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_MHICalenderOutput"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPHenkoShori_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_GetShisanNumForCheck"/>
      <snippet name="SAPLogin_BR_MAS_08_FIXED_ASSET_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPShisanTorihikiZandaka_DA047"/>
      <snippet name="BR_MAS_08_FIXED_ASSET_08_SAPBackToMenuPage_DA047"/>
    </referenced-snippets>
    <typed-variables>
            ...
            <property name="stepAction" class="AssignVariable" serializationversion="4">
              <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String">CNST.SETTING9</property>
                </property>
              </property>
              <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            ...
            <steps class="ArrayList">
              ...
              <object class="Transition" serializationversion="3" id="156">
                ...
                <property name="stepAction" class="CallRobot2Step">
                  <property name="robot2Name" class="String">DA_画面初期化(3)_DA047</property>
                  ...
                  <property name="remoteHubReferences" class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReferences">
                    <object class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReference" serializationversion="1">
                      <property name="reference" class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReference$StaticReference">
                        <property name="deviceName" class="String">DA047</property>
                      </property>
                    </object>
                  </property>
                </property>
          ...
          <object class="Group" id="160">
            ...
            <steps class="ArrayList">
              ...
              <object class="SnippetStep" id="165">
                <name class="String">SAPログイン</name>
                <snippetName class="String">SAPLogin_BR_MAS_08_FIXED_ASSET_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
              ...
              <object class="Group" id="175">
                ...
                <steps class="ArrayList">
                  ...
                  <object class="Transition" serializationversion="3" id="179">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">資産データ変更・分割_DA_Web固定資産システム起動(1)_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  ...
                  <object class="Transition" serializationversion="3" id="181">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_ログイン～移管伺一覧表示(1)_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              ...
              <object class="Group" id="184">
                ...
                <steps class="ArrayList">
                  ...
                  <object class="Transition" serializationversion="3" id="187">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_検索条件入力・検索実行(1)_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  ...
                  <object class="Transition" serializationversion="3" id="193">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_移管伺検索結果リストDL_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              ...
              <object class="Group" id="245">
                ...
                <steps class="ArrayList">
                  ...
                  <object class="Transition" serializationversion="3" id="248">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_画面初期化(3)_02_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              ...
              <object class="Group" id="257">
                ...
                <steps class="ArrayList">
                  ...
                  <object class="Transition" serializationversion="3" id="260">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_検索条件入力・検索実行(2)_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  ...
                  <object class="Transition" serializationversion="3" id="262">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_申請番号で検索_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              ...
              <object class="Group" id="265">
                ...
                <steps class="ArrayList">
                  ...
                  <object class="Transition" serializationversion="3" id="268">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_完了年月日取得_DA047</property>
                      <property name="outputVariables" class="kapow.robot.plugin.common.stepaction.rl2.OutputVariableBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.OutputVariable">
                          <property name="attributeName" class="kapow.robot.plugin.common.support.AttributeName2">
              ...
              <object class="Group" id="283">
                ...
                <steps class="ArrayList">
                  ...
                  <object class="Transition" serializationversion="3" id="286">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_編集ボタンクリック_DA047</property>
                      <property name="outputVariables" class="kapow.robot.plugin.common.stepaction.rl2.OutputVariableBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.OutputVariable">
                          <property name="attributeName" class="kapow.robot.plugin.common.support.AttributeName2">
                            <property name="name" class="String">lcl.daErrorFlg</property>
              ...
              <object class="Group" id="289">
                ...
                <steps class="ArrayList">
                  <object class="Transition" serializationversion="3" id="291">
                    ...
                    <property name="stepAction" class="CallRobot2Step">
                      <property name="robot2Name" class="String">DA_CSVファイルDL～移管伺一覧へ戻る_DA047</property>
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                        <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                          <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
          ...
          <object class="Group" id="346">
            ...
            <steps class="ArrayList">
              ...
              <object class="Transition" serializationversion="3" id="349">
                ...
                <property name="stepAction" class="CallRobot2Step">
                  <property name="robot2Name" class="String">DA_マスタ変更データDL_DA047</property>
                  <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
                    <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
                      <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                        <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
          ...
          <object class="Group" id="359">
            ...
            <steps class="ArrayList">
              ...
              <object class="SnippetStep" id="368">
                <name class="String">資産マスタ検索リストDL</name>
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPListDL_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
...
　問1240</property>
                  ...
                  <object class="SnippetStep" id="382">
                    ...
                    <snippetName class="String">ExeceuteMacroOnDA_BR_MAS_08_FIXED_ASSET_DA047</snippetName>
                    <snippetStepComment>
                      <null/>
                    </snippetStepComment>
                  </object>
          ...
          <object class="Group" id="416">
            ...
            <steps class="ArrayList">
              ...
              <object class="SnippetStep" id="420">
                ...
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPHenkoShori_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
              ...
              <object class="SnippetStep" id="425">
                ...
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPBackToMenuPage_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
              ...
              <object class="SnippetStep" id="428">
                ...
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPHenkoErrShori_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
          ...
          <object class="Group" id="433">
            ...
            <steps class="ArrayList">
              ...
              <object class="SnippetStep" id="436">
                ...
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPKanzenReport_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
          ...
          <object class="Group" id="441">
            ...
            <steps class="ArrayList">
              ...
              <object class="SnippetStep" id="454">
                <name class="String">分割処理</name>
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPBunkatsuShori_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
          ...
          <object class="Group" id="504">
            ...
            <steps class="ArrayList">
              <object class="SnippetStep" id="506">
                ...
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPShisanTorihikiZandaka_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
          ...
          <object class="SnippetStep" id="511">
            ...
            <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPBubunReport_DA047</snippetName>
            <snippetStepComment>
              <null/>
            </snippetStepComment>
          </object>
          ...
          <object class="Group" id="563">
            ...
            <steps class="ArrayList">
              ...
              <object class="SnippetStep" id="566">
                ...
                <snippetName class="String">BR_MAS_08_FIXED_ASSET_08_SAPListDLForCheck_DA047</snippetName>
                <snippetStepComment>
                  <null/>
                </snippetStepComment>
              </object>
