                ...
                "steps": [{
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "Directoryカーソル合わせる" }
                      }
                    },
                    "comment": {
                      "meta":{
                                    ...
                                    "applicationFinder": {
                                      ...
                                      "gizmo":{
                                        ...
                                        "applicationSelector": {
                                          ...
                                          "gizmo":{
                                            "text": { "string": "saplogon.exe[className=\"#32770\"][title*=\"資産取引残高一覧\"]" }
                                          }
                                        }
                                      }
                                    },
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "File名カーソル合わせる" }
                      }
                    },
                    "comment": {
                      "meta":{
