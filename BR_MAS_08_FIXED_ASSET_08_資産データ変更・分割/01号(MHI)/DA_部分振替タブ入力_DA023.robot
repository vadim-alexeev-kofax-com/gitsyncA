...
<object class="Robot2" serializationversion="2">
  ...
  "gizmo":{
    ...
    },
    {
      ...
      "gizmo":{
        "id": { "string": "longTermMaebaraiCost" },
        "typ": {
          "meta":{
            "className":"TypeUse",
            "version":0
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "contents": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=bubunEnterContents.getAmount" }
                                  }
                                }
                              }
                            },
                    ...
                    "branches": [{
                      ...
                      "gizmo":{
                        "condition": {
                          ...
                          "gizmo":{
                            "text": { "string": "=mukoCheakFlgTax==true || longTermMaebaraiCost==true" }
                          }
                        },
                        "block": {
                          "meta":{
                    ...
                    },
                    {
                      ...
                      "gizmo":{
                        "condition": {
                          ...
                          "gizmo":{
                            "text": { "string": "=mukoCheakFlgTax==false &amp;&amp; longTermMaebaraiCost==false" }
                          }
                        },
                        "block": {
                          "meta":{
                                            ...
                                            "finder": {
                                              ...
                                              "gizmo":{
                                                ...
                                                "componentSelector": {
                                                  ...
                                                  "gizmo":{
                                                    "text": { "string": "RAIFP2-MENGE[sapTypeNumber=\"31\"]" }
                                                  }
                                                }
                                              }
                                            }
                                        ...
                                        },
                                        {
                                          ...
                                          "gizmo":{
                                            ...
                                            "contents": {
                                              ...
                                              "gizmo":{
                                                "text": { "string": "=bubunEnterContents.ikanAmount" }
                                              }
                                            }
                                          }
                                        },
                                                ...
                                                "branches": [{
                                                  ...
                                                  "gizmo":{
                                                    "condition": {
                                                      ...
                                                      "gizmo":{
                                                        "text": { "string": "=statusMsg==\"旧資産データの除却はできません (旧資産データが存在しません)\"" }
                                                      }
                                                    },
                                                    "block": {
                                                      "meta":{
                                                ...
                                                },
                                                {
                                                  ...
                                                  "gizmo":{
                                                    "condition": {
                                                      ...
                                                      "gizmo":{
                                                        "text": { "string": "=statusMsg==\"振替ﾊﾞﾘｱﾝﾄ(追加詳細ﾀﾌﾞ)･･･他勘定振替:'4'、同勘定振替:'Z'\"" }
                                                      }
                                                    },
                                                    "block": {
                                                      "meta":{
                                                ...
                                                },
                                                {
                                                  ...
                                                  "gizmo":{
                                                    "condition": {
                                                      ...
                                                      "gizmo":{
                                                        "text": { "string": "=statusMsg!=\"旧資産データの除却はできません (旧資産データが存在しません)\" &amp;&amp; statusMsg!=\"振替ﾊﾞﾘｱﾝﾄ(追加詳細ﾀﾌﾞ)･･･他勘定振替:'4'、同勘定振替:'Z'\"" }
                                                      }
                                                    },
                                                    "block": {
                                                      "meta":{
