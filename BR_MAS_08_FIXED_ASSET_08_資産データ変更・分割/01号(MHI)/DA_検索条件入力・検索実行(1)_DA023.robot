                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "正常ファインダー探す（Try-Catch）" }
                      }
                    },
                    "comment": {
                      "meta":{
                        ...
                        },
                        {
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "処理対象申請番号ありフラグを立てる" }
                              }
                            },
                            "comment": {
                              "meta":{
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "検索結果チェック（Try-Catch）" }
                      }
                    },
                    "comment": {
                      "meta":{
