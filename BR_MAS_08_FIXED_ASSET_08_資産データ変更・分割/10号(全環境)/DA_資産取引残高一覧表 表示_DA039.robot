                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "__ANLAGE___APP__-VALU_PUSH" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "RSCSEL-SLOW_I[index=\"8\"]" }
                                      }
                                    }
                                  }
                                }
                ...
                },
                {
                  ...
                  "gizmo":{
                    ...
                    "contents": {
                      ...
                      "gizmo":{
                        "text": { "string": "=bubun_shisanNumNew" }
                      }
                    }
                  }
                },
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "クリップボードからアップロード" }
                      }
                    },
                    "comment": {
                      "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "資産番号の複数選択 実行クリック" }
              }
            },
            "comment": {
              "meta":{
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "エラー対応1（Try-Catch）正常ファインダーを探す" }
                      }
                    },
                    "comment": {
                      "meta":{
                                        ...
                                        "finder": {
                                          ...
                                          "gizmo":{
                                            ...
                                            "componentSelector": {
                                              ...
                                              "gizmo":{
                                                "text": { "string": "btn_9_[sapId*=\"/app/con[\"]" }
                                              }
                                            }
                                          }
                                        }
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "エラー対応2（Try-Catch）画面遷移前エラーメッセージ出力" }
                      }
                    },
                    "comment": {
                      "meta":{
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "エラー対応3（Try-Catch）画面遷移後エラーメッセージ出力" }
                      }
                    },
                    "comment": {
                      "meta":{
