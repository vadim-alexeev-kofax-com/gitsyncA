                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "固定資産移管完了報告書取得" }
                              }
                            },
                            "comment": {
                              "meta":{
                                        ...
                                        "finder": {
                                          ...
                                          "gizmo":{
                                            ...
                                            "componentSelector": {
                                              ...
                                              "gizmo":{
                                                "text": { "string": "DIV[style=\"FONT-SIZE: 20pt; MARGIN-LEFT: 30px\"]" }
                                              }
                                            }
                                          }
                                        }
