                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "名前を付けて保存 Click" }
                      }
                    },
                    "comment": {
                      "meta":{
