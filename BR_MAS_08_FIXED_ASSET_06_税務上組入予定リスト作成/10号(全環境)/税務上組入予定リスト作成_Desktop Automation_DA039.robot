...
<object class="Robot2" serializationversion="2">
  <prologue>
    ...
    <referenced-types>
      <type name="BR_MAS_08_FIXED_ASSET_06_SAP_Screen_Transition"/>
    </referenced-types>
    <triggers/>
    <sub-robots/>
    <device-mappings/>
    ...
    "parameters": [{
      ...
      "gizmo":{
        ...
        "typ": {
          ...
          "gizmo":{
            "id": { "string": "BR_MAS_08_FIXED_ASSET_06_SAP_Screen_Transition" }
          }
        }
      }
    }],
                                ...
                                },
                                {
                                  ...
                                  "gizmo":{
                                    "name": {
                                      ...
                                      "gizmo":{
                                        "customName": { "string": "コマンドフィールドClick" }
                                      }
                                    },
                                    "comment": {
                                      "meta":{
                                                    ...
                                                    "applicationFinder": {
                                                      ...
                                                      "gizmo":{
                                                        ...
                                                        "applicationSelector": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "saplogon.exe[title^=\"SAP Easy Access\"][title*=\"メニュー\"]" }
                                                          }
                                                        }
                                                      }
                                                    },
                                ...
                                },
                                {
                                  ...
                                  "gizmo":{
                                    ...
                                    "contents": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=inputParams.transactionCode" }
                                      }
                                    }
                                  }
                                },
                                            ...
                                            "branches": [{
                                              ...
                                              "gizmo":{
                                                "condition": {
                                                  ...
                                                  "gizmo":{
                                                    "text": { "string": "=inputTextExtract == inputParams.transactionCode" }
                                                  }
                                                },
                                                "block": {
                                                  "meta":{
                                    ...
                                    "branches": [{
                                      ...
                                      "gizmo":{
                                        "condition": {
                                          ...
                                          "gizmo":{
                                            "text": { "string": "=loopCnt &gt; inputParams.transitionCheckLimitNumber" }
                                          }
                                        },
                                        "block": {
                                          "meta":{
                                                        ...
                                                        "finder": {
                                                          ...
                                                          "gizmo":{
                                                            "applicationFinder": {
                                                              ...
                                                              "gizmo":{
                                                                ...
                                                                "applicationSelector": {
                                                                  ...
                                                                  "gizmo":{
                                                                    "text": { "string": "=\"saplogon.exe[title^=\\\"\"+inputParams.sapWindowTitle+\"\\\"]\"" }
                                                                  }
                                                                }
                                                              }
                                                            },
                                                            "componentSelector": {
                                                              ...
                                                              "gizmo":{
                                                                "text": { "string": "=\"ウィンドウ[name^=\\\"\"+inputParams.sapWindowTitle+\"\\\"]\"" }
                                                              }
                                                            }
                                                          }
                                                        }
