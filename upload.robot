...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <tags/>
    <typed-variables>
      <typed-variable name="file" type-name="file"/>
    </typed-variables>
    <parameters>
      <parameter name="file" type-name="file"/>
    </parameters>
    ...
    <object class="Variable" serializationversion="1">
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">file</property>
        </property>
      </property>
    </object>
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">log</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="2">
        <property name="name" class="String">Assign Log</property>
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="Expression" serializationversion="1">
            <property name="text" class="String">length(binaryToText(file.value))</property>
          </property>
